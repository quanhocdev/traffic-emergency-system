...
@Query("""
        SELECT new com.example.suco.dto.SuCoMapDto(
            ...
            b.doTinCay, null, null, null, null, b.diaChi, b.reporter.name
        )
        FROM BaoCaoSuCo b
  ...
  @Query("""
    ...
    // 3. Lấy lịch sử cá nhân (QUAN TRỌNG NHẤT ĐỂ ANDROID HẾT XOAY)
    // @Query("""
    //     SELECT new com.example.suco.dto.SuCoMapDto(
    //         b.id, b.viDo, b.kinhDo, b.moTa, b.loaiSuCo.ten,
    //         b.trangThaiDuyet, b.trangThaiXuLy, b.loaiSuCo.iconUrl,
    ...
    //     )
    //     FROM BaoCaoSuCo b
    //     WHERE b.reporter.uid = :uid
    //     ORDER BY b.thoiGianTao DESC
    // """)
    //List<SuCoMapDto> findDtoByReporterUid(@Param("uid") String uid);
